...
BEGIN
  FOR i IN 1..100 LOOP
    INSERT INTO groomer (
      ...
      LOWER(v_first_names(MOD(i-1, v_first_names.COUNT)+1)) || '.' || LOWER(v_last_names(MOD(i-1, v_last_names.COUNT)+1)) || i || '@groomers.com',
      ...
      'Street ' || TRUNC(DBMS_RANDOM.VALUE(1, 200)) || ', City',
